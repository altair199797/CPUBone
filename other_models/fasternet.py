...
def get_fasternet(version):

    bpath = "/home/moritz/Research/efficientvit-master/other_models/fasternet_cfg/fasternet_"+version + ".yaml"
    # with open(, "r") as read_file:
    #     lines = read_file.readlines()
    
    
    cfg_dict = load_cfg(bpath)    
    # print(cfg_dict)
    model = FasterNet(**cfg_dict)
