...
Pretrained weights are expected at `.exp/cls/imagenet/cpubone_<name>/checkpoint/evalmodel.pt`. Both the config path and checkpoint path can be passed explicitly:
